    ...
    <div class="modal-dialog">
      <div class="modal-content" >
        <div class="modal-header">
          ...
          <p class="modal-title" id="exampleModalLabel">Are you sure you confirm the payment?</p>
        </div>
        ...
        <form action="" method="POST">
          <div  class="modal-footer" style="display: flex;">
              ...
              <button name="confirm" value="confirm" type="submit" class="btn btn-dark">Confirm</button>
          </div>
        </form>
      </div>
    </div>
